...
#define RT_LWIP_UDP_PCB_NUM   140
...
#define RT_LWIP_IPADDR1	4
#define RT_LWIP_IPADDR2	6
#define RT_LWIP_IPADDR3	81


/* gateway address of target*/
#define RT_LWIP_GWADDR0	10
#define RT_LWIP_GWADDR1	4
