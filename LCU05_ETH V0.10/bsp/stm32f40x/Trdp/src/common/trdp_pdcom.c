 ...
 *
 * $Id: trdp_pdcom.c 1740 2018-06-20 16:03:12Z bloehr $
 *
 ...
 */
static uint32_t maskPrintfTest = 0;
    ...
    SOCKET          sock)
{
    ...
    if((subAddresses.comId == maskPrintfTest) || (maskPrintfTest == 0))
    {
      //2019-5-14 ÆÁ±Î´òÓ¡ÐÅÏ¢
      //rt_kprintf("\r\n rt=%d, comId=%d,ip=0x%x",rt_tick_get(),subAddresses.comId,subAddresses.srcIpAddr);
    }
...
///////////////////////////////////////////////////////////////////////////
void ethpdrx_mask(uint32_t msg)
{
  maskPrintfTest = msg;
}

#include "finsh.h"
FINSH_FUNCTION_EXPORT(ethpdrx_mask, set eth pd rx mask)
